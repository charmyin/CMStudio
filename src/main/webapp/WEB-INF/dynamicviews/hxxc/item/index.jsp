...
<body>
    ...
    <table id="dg" title="7s检查评价内容" class="easyui-datagrid"
        ...
        <thead>
            <tr>
                ...
                <th field="typeId" width="50">评价分类</th>
    ...
    <div id="dlg" class="easyui-dialog" style="width:400px;height:310px;padding:10px 20px"
        ...
        <form id="fm" method="post" novalidate>
            ...
            <div class="fitem">
                <label>评价分类:</label>
                <input id="typeid" class="easyui-validatebox" name="typeId">
    ...
    <script type="text/javascript">
        ...
        function editUser(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                url = 'hxxc/item/update?id='+row.id+'&RECORD_STATUS=0';
            }
        }
        function saveUser(){
            ...
            if (row){
            	$.messager.confirm('提示','你确定删除吗?',function(r){
            		if (r){
                          ...
                          $('#fm').form('load',row);
                          url = 'hxxc/item/deleteById?id='+row.id+'&RECORD_STATUS=1';
                          saveUser();
            		}
            	})
